package test.jsoup.china.to.english;
...
public class ChinaToEnglish {
 ...
 private static ChinaToEnglish chineseSpelling = new ChinaToEnglish();  
 public static ChinaToEnglish getInstance() {  
 ...
 public static String trans2PinYin(String str) {  
     return ChinaToEnglish.getInstance().convertAll(str);  
 }  
 public static void main(String[] args) {  
     String str = "你好,Hello！我是,这个zhongguo";  
