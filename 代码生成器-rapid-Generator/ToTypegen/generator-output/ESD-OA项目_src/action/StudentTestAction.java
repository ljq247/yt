...
public class StudentTestAction  extends   BaseAction{	
	...
	private StudentTest  bean;
	private Map<String  ,String > pm=ThMap.getmap(StudentTest.class);
	...
	public StudentTest getBean() {
		return bean;
	}

	public void setBean(StudentTest bean) {
		this.bean = bean;
	}
	///自己创建的方法
