...
<s:hidden name="bean.id" />
    ...
    <table id="baseInfo" width="100%" class="list" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				<td width="200" class="tdBg"><span class="fRed">*</span>${pm.birthday} </td>
				<td colspan="3">
					<s:property value="bean.birthday"/>
				</td>
			</tr>
			<tr>
				<td width="200" class="tdBg"><span class="fRed">*</span>${pm.phone} </td>
				<td colspan="3">
					<s:property value="bean.phone"/>
				</td>
			</tr>
			<tr>
				<td width="200" class="tdBg"><span class="fRed">*</span>${pm.organization} </td>
				<td colspan="3">
					<s:property value="bean.organization"/>
				</td>
			</tr>
			<tr>
