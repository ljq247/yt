...
<form id="form2" name="form2" method="post" action="${ctx}/sys/person!addPerson.action">
    ...
    <table id="baseInfo" width="100%" class="list" border="0" cellpadding="0" cellspacing="0" >
				...
				<tr  class="check_r">
					<td width="43%" class="tdBg"><span class="fRed">*</span>${pm.birthday}：</td>
					<td colspan="3">
							<s:textfield   name="bean.birthday" id="birthday" cssClass="input" cssStyle="width:200px;"/>
					</td>
				</tr>
				<tr  class="check_r">
					<td width="43%" class="tdBg"><span class="fRed">*</span>${pm.phone}：</td>
					<td colspan="3">
							<s:textfield   name="bean.phone" id="phone" cssClass="input" cssStyle="width:200px;"/>
					</td>
				</tr>
				<tr  class="check_r">
					<td width="43%" class="tdBg"><span class="fRed">*</span>${pm.organization}：</td>
					<td colspan="3">
							<s:textfield   name="bean.organization" id="organization" cssClass="input" cssStyle="width:200px;"/>
					</td>
				</tr>
				<tr  class="check_r">
...
<script>
var saveUrl = "${ctx}/birthdaybless_test/temporaryPersonManger!create.action?pageNo=${pageNo}";//表单列表save的url地址
