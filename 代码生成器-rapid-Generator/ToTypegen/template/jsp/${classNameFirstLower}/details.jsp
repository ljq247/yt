...
<form id="form2" name="form2" method="post" action="<@jspEl 'ctx' />/sys/person!modPerson.action">
<s:hidden name="bean.id" />
	...
	<#list table.columns as c>
		...
		<#else>										
			<tr>
				<td width="200" class="tdBg"><span class="fRed">*</span>${r"${"}pm.${c.columnNameLower}${r"}"} </td>
				<td colspan="3">
					<s:property value="bean.${c.columnNameLower}"/>
				</td>
			</tr>
		</#if>
	</#list> 	
